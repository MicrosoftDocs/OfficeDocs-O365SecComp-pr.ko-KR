...
-  <span data-ttu-id="ab3e1-112">22 개 문자 (대/소문자 구분 안 함), 숫자, 백슬래시, 슬래시 또는 더하기 기호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-112">22 letters (not case-sensitive), digits, backslashes, forward slashes, or plus signs</span></span> 
...
<span data-ttu-id="ab3e1-123">국가 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-123">national identity number</span></span>
...
<span data-ttu-id="ab3e1-139">예</span><span class="sxs-lookup"><span data-stu-id="ab3e1-139">Yes</span></span>
...
<span data-ttu-id="ab3e1-150">불가리아어 국가 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-150">bulgarian national number</span></span>
...
### <a name="format"></a><span data-ttu-id="ab3e1-168">형식일</span><span class="sxs-lookup"><span data-stu-id="ab3e1-168">Format</span></span>
...
<span data-ttu-id="ab3e1-180">id 카드 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-180">id card number</span></span>
...
- <span data-ttu-id="ab3e1-195">출생 날짜에 해당 하는 6 자리 숫자 (YYMMDD)</span><span class="sxs-lookup"><span data-stu-id="ab3e1-195">Six digits that correspond to date of birth (YYMMDD)</span></span>
...
### <a name="keywords"></a><span data-ttu-id="ab3e1-206">키워드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-206">Keywords</span></span>
...
## <a name="germany"></a><span data-ttu-id="ab3e1-221">독일</span><span class="sxs-lookup"><span data-stu-id="ab3e1-221">Germany</span></span>
...
<span data-ttu-id="ab3e1-235">예</span><span class="sxs-lookup"><span data-stu-id="ab3e1-235">Yes</span></span>
...
<span data-ttu-id="ab3e1-246">개인 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-246">personal id number</span></span>
...
### <a name="definition"></a><span data-ttu-id="ab3e1-263">정의</span><span class="sxs-lookup"><span data-stu-id="ab3e1-263">Definition</span></span>
...
<span data-ttu-id="ab3e1-275">개인 식별 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-275">personal identification number</span></span>
...
- <span data-ttu-id="ab3e1-291">사용자가 태어난 municipality 관련 지역 번호에 해당 하는 4 자리 숫자 (국가 전체 코드는 외국 국가에 사용 됨)</span><span class="sxs-lookup"><span data-stu-id="ab3e1-291">Four digits that corresponds to the area code specific to the municipality where the person was born (country-wide codes are used for foreign countries)</span></span>
...
#### <a name="keywordsitalyeunationalidcard"></a><span data-ttu-id="ab3e1-302">Keywords_italy_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="ab3e1-302">Keywords_italy_eu_national_id_card</span></span>
...
<span data-ttu-id="ab3e1-320">11 자리 숫자와 하이픈:</span><span class="sxs-lookup"><span data-stu-id="ab3e1-320">11 digits and a hyphen:</span></span>
...
### <a name="keywords"></a><span data-ttu-id="ab3e1-333">키워드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-333">Keywords</span></span>
...
- <span data-ttu-id="ab3e1-349">출생 날짜의 일련 번호에 해당 하는 3 자리 숫자</span><span class="sxs-lookup"><span data-stu-id="ab3e1-349">Three digits that correspond to the serial number of the date of birth</span></span>
...
#### <a name="keywordslithuaniaeunationalidcard"></a><span data-ttu-id="ab3e1-360">Keywords_lithuania_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="ab3e1-360">Keywords_lithuania_eu_national_id_card</span></span>
...
- <span data-ttu-id="ab3e1-377">사용자의 성별 및 출생 세기에 해당 하는 1 자리 숫자</span><span class="sxs-lookup"><span data-stu-id="ab3e1-377">One digit that corresponds to the person's gender and century of birth</span></span>
...
<span data-ttu-id="ab3e1-389">개인 id</span><span class="sxs-lookup"><span data-stu-id="ab3e1-389">personal id</span></span>
...
<span data-ttu-id="ab3e1-408">7 자리 숫자와 문자 1 개</span><span class="sxs-lookup"><span data-stu-id="ab3e1-408">Seven digits followed by one letter</span></span>
...
### <a name="keywords"></a><span data-ttu-id="ab3e1-421">키워드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-421">Keywords</span></span>
...
<span data-ttu-id="ab3e1-438">예</span><span class="sxs-lookup"><span data-stu-id="ab3e1-438">Yes</span></span>
...
<span data-ttu-id="ab3e1-449">시민 서비스 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-449">citizen service number</span></span>
...
### <a name="pattern"></a><span data-ttu-id="ab3e1-465">패턴</span><span class="sxs-lookup"><span data-stu-id="ab3e1-465">Pattern</span></span>
...
#### <a name="keywordsromaniaeunationalidcard"></a><span data-ttu-id="ab3e1-476">Keywords_romania_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="ab3e1-476">Keywords_romania_eu_national_id_card</span></span>
...
<span data-ttu-id="ab3e1-490">număr personal unic</span><span class="sxs-lookup"><span data-stu-id="ab3e1-490">număr personal unic</span></span>
  
<span data-ttu-id="ab3e1-491">număr identitate</span><span class="sxs-lookup"><span data-stu-id="ab3e1-491">număr identitate</span></span>
  
<span data-ttu-id="ab3e1-492">număr identificare personal</span><span class="sxs-lookup"><span data-stu-id="ab3e1-492">număr identificare personal</span></span>
  
<span data-ttu-id="ab3e1-493">număridentitate #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-493">număridentitate#</span></span>
  
<span data-ttu-id="ab3e1-494">codnumericpersonal #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-494">codnumericpersonal#</span></span>
  
<span data-ttu-id="ab3e1-495">numărpersonalunic #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-495">numărpersonalunic#</span></span>
  
## <a name="slovakia"></a><span data-ttu-id="ab3e1-496">슬로바키아</span><span class="sxs-lookup"><span data-stu-id="ab3e1-496">Slovakia</span></span>

### <a name="format"></a><span data-ttu-id="ab3e1-497">형식일</span><span class="sxs-lookup"><span data-stu-id="ab3e1-497">Format</span></span>

<span data-ttu-id="ab3e1-498">백슬래시 하나를 포함 하는 10 자리 숫자</span><span class="sxs-lookup"><span data-stu-id="ab3e1-498">Ten digits containing one backslash</span></span>
  
### <a name="pattern"></a><span data-ttu-id="ab3e1-499">패턴</span><span class="sxs-lookup"><span data-stu-id="ab3e1-499">Pattern</span></span>

<span data-ttu-id="ab3e1-500">백슬래시 하나를 포함 하는 10 자리 숫자:</span><span class="sxs-lookup"><span data-stu-id="ab3e1-500">Ten digits containing one backslash:</span></span>
  
### <a name="checksum"></a><span data-ttu-id="ab3e1-501">제외</span><span class="sxs-lookup"><span data-stu-id="ab3e1-501">Checksum</span></span>

<span data-ttu-id="ab3e1-502">예</span><span class="sxs-lookup"><span data-stu-id="ab3e1-502">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="ab3e1-503">정의</span><span class="sxs-lookup"><span data-stu-id="ab3e1-503">Definition</span></span>

<span data-ttu-id="ab3e1-504">DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 85% 신뢰합니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-504">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="ab3e1-505">이 함수 `Func_slovakia_eu_national_id_card` 는 해당 패턴과 일치 하는 콘텐츠를 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-505">The function  `Func_slovakia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="ab3e1-506">from `Keywords_slovakia_eu_national_id_card` 키워드를 찾았습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-506">A keyword from  `Keywords_slovakia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="ab3e1-507">DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 75% 신뢰합니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-507">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="ab3e1-508">이 함수 `Func_slovakia_eu_national_id_card` 는 해당 패턴과 일치 하는 콘텐츠를 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-508">The function  `Func_slovakia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="ab3e1-509">키워드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-509">Keywords</span></span>

#### <a name="keywordsslovakiaeunationalidcard"></a><span data-ttu-id="ab3e1-510">Keywords_slovakia_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="ab3e1-510">Keywords_slovakia_eu_national_id_card</span></span>

<span data-ttu-id="ab3e1-511">돌 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-511">birth number</span></span>
  
<span data-ttu-id="ab3e1-512">national identification number</span><span class="sxs-lookup"><span data-stu-id="ab3e1-512">national identification number</span></span>
  
<span data-ttu-id="ab3e1-513">개인 식별 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-513">personal identification number</span></span>
  
<span data-ttu-id="ab3e1-514">social security number</span><span class="sxs-lookup"><span data-stu-id="ab3e1-514">social security number</span></span>
  
<span data-ttu-id="ab3e1-515">nationalnumber #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-515">nationalnumber#</span></span>
  
<span data-ttu-id="ab3e1-516">ssn</span><span class="sxs-lookup"><span data-stu-id="ab3e1-516">ssn#</span></span>
  
<span data-ttu-id="ab3e1-517">ssn</span><span class="sxs-lookup"><span data-stu-id="ab3e1-517">ssn</span></span>
  
<span data-ttu-id="ab3e1-518">국가 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-518">national number</span></span>
  
<span data-ttu-id="ab3e1-519">개인 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-519">personal id number</span></span>
  
<span data-ttu-id="ab3e1-520">personalidnumber #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-520">personalidnumber#</span></span>
  
<span data-ttu-id="ab3e1-521">rč</span><span class="sxs-lookup"><span data-stu-id="ab3e1-521">rč</span></span>
  
<span data-ttu-id="ab3e1-522">rodné číslo</span><span class="sxs-lookup"><span data-stu-id="ab3e1-522">rodné číslo</span></span>
  
<span data-ttu-id="ab3e1-523">rodne cislo</span><span class="sxs-lookup"><span data-stu-id="ab3e1-523">rodne cislo</span></span>
  
## <a name="slovenia"></a><span data-ttu-id="ab3e1-524">슬로베니아</span><span class="sxs-lookup"><span data-stu-id="ab3e1-524">Slovenia</span></span>

### <a name="format"></a><span data-ttu-id="ab3e1-525">형식일</span><span class="sxs-lookup"><span data-stu-id="ab3e1-525">Format</span></span>

<span data-ttu-id="ab3e1-526">공백이 나 구분 기호가 없는 13 자리 숫자</span><span class="sxs-lookup"><span data-stu-id="ab3e1-526">13 digits without spaces or delimiters</span></span>
  
### <a name="pattern"></a><span data-ttu-id="ab3e1-527">패턴</span><span class="sxs-lookup"><span data-stu-id="ab3e1-527">Pattern</span></span>

<span data-ttu-id="ab3e1-528">지정 된 패턴의 13 자리 숫자:</span><span class="sxs-lookup"><span data-stu-id="ab3e1-528">13 digits in the specified pattern:</span></span>
  
-  <span data-ttu-id="ab3e1-529">생년월일 (ddmmlll)에 해당 하는 7 자리 숫자 이며 "lll"은 출생 연도의 마지막 세 자리에 해당 합니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-529">Seven digits that correspond to the birth date (DDMMLLL) where "LLL" corresponds to the last three digits of the birth year</span></span> 
    
- <span data-ttu-id="ab3e1-530">출생 면적에 해당 하는 2 자리 숫자</span><span class="sxs-lookup"><span data-stu-id="ab3e1-530">Two digits that correspond to the area of birth</span></span>
    
- <span data-ttu-id="ab3e1-531">같은 날에 태어난 사용자의 성별 및 일련 번호 조합에 해당 하는 3 자리 숫자 (남성는 000-499, 암은 500-999)</span><span class="sxs-lookup"><span data-stu-id="ab3e1-531">Three digits that correspond to a combination of gender and serial number for persons born on the same day (000-499 for male and 500-999 for female)</span></span>
    
- <span data-ttu-id="ab3e1-532">검사 숫자 1 개</span><span class="sxs-lookup"><span data-stu-id="ab3e1-532">One check digit</span></span>
    
### <a name="checksum"></a><span data-ttu-id="ab3e1-533">제외</span><span class="sxs-lookup"><span data-stu-id="ab3e1-533">Checksum</span></span>

<span data-ttu-id="ab3e1-534">예</span><span class="sxs-lookup"><span data-stu-id="ab3e1-534">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="ab3e1-535">정의</span><span class="sxs-lookup"><span data-stu-id="ab3e1-535">Definition</span></span>

<span data-ttu-id="ab3e1-536">DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 85% 신뢰합니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-536">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="ab3e1-537">이 함수 `Func_slovenia_eu_national_id_card` 는 해당 패턴과 일치 하는 콘텐츠를 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-537">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="ab3e1-538">from `Keywords_slovenia_eu_national_id_card` 키워드를 찾았습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-538">A keyword from  `Keywords_slovenia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="ab3e1-539">DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 75% 신뢰합니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-539">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="ab3e1-540">이 함수 `Func_slovenia_eu_national_id_card` 는 해당 패턴과 일치 하는 콘텐츠를 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-540">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="ab3e1-541">키워드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-541">Keywords</span></span>

#### <a name="keywordssloveniaeunationalidcard"></a><span data-ttu-id="ab3e1-542">Keywords_slovenia_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="ab3e1-542">Keywords_slovenia_eu_national_id_card</span></span>

<span data-ttu-id="ab3e1-543">개인 숫자 코드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-543">personal numeric code</span></span>
  
<span data-ttu-id="ab3e1-544">고유 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-544">unique identification number</span></span>
  
<span data-ttu-id="ab3e1-545">고유 등록 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-545">unique registration number</span></span>
  
<span data-ttu-id="ab3e1-546">고유 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-546">unique identity number</span></span>
  
<span data-ttu-id="ab3e1-547">uniqueidentityno #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-547">uniqueidentityno#</span></span>
  
<span data-ttu-id="ab3e1-548">고유 마스터 시민 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-548">unique master citizen number</span></span>
  
<span data-ttu-id="ab3e1-549">ed명령이 vena identifikacijska številka</span><span class="sxs-lookup"><span data-stu-id="ab3e1-549">edinstvena identifikacijska številka</span></span>
  
<span data-ttu-id="ab3e1-550">uniqueidentityno #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-550">uniqueidentityno #</span></span>
  
<span data-ttu-id="ab3e1-551">ed명령이 vena številka glavnega državljana</span><span class="sxs-lookup"><span data-stu-id="ab3e1-551">edinstvena številka glavnega državljana</span></span>
  
<span data-ttu-id="ab3e1-552">emšo</span><span class="sxs-lookup"><span data-stu-id="ab3e1-552">emšo</span></span>
  
## <a name="spain"></a><span data-ttu-id="ab3e1-553">스페인</span><span class="sxs-lookup"><span data-stu-id="ab3e1-553">Spain</span></span>

### <a name="format"></a><span data-ttu-id="ab3e1-554">형식일</span><span class="sxs-lookup"><span data-stu-id="ab3e1-554">Format</span></span>

<span data-ttu-id="ab3e1-555">7 자리 숫자와 문자 1 개</span><span class="sxs-lookup"><span data-stu-id="ab3e1-555">Seven digits followed by one character</span></span>
  
### <a name="pattern"></a><span data-ttu-id="ab3e1-556">패턴</span><span class="sxs-lookup"><span data-stu-id="ab3e1-556">Pattern</span></span>

<span data-ttu-id="ab3e1-557">7 자리 숫자와 문자 1 개</span><span class="sxs-lookup"><span data-stu-id="ab3e1-557">Seven digits followed by one character</span></span>
  
- <span data-ttu-id="ab3e1-558">7자리 숫자</span><span class="sxs-lookup"><span data-stu-id="ab3e1-558">Seven digits</span></span>
    
- <span data-ttu-id="ab3e1-559">1 자리 숫자 또는 문자 (대/소문자 구분 안 함)</span><span class="sxs-lookup"><span data-stu-id="ab3e1-559">One digit or letter (not case-sensitive)</span></span>
    
### <a name="checksum"></a><span data-ttu-id="ab3e1-560">제외</span><span class="sxs-lookup"><span data-stu-id="ab3e1-560">Checksum</span></span>

<span data-ttu-id="ab3e1-561">해당 없음</span><span class="sxs-lookup"><span data-stu-id="ab3e1-561">Not applicable</span></span>
  
### <a name="definition"></a><span data-ttu-id="ab3e1-562">정의</span><span class="sxs-lookup"><span data-stu-id="ab3e1-562">Definition</span></span>

<span data-ttu-id="ab3e1-563">DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 75% 신뢰합니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-563">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="ab3e1-564">정규식이 해당 `Regex_spain_eu_national_id_card` 패턴과 일치 하는 콘텐츠를 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-564">The regular expression  `Regex_spain_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="ab3e1-565">from `Keywords_spain_eu_national_id_card"` 키워드를 찾았습니다.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-565">A keyword from  `Keywords_spain_eu_national_id_card"` is found.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="ab3e1-566">키워드</span><span class="sxs-lookup"><span data-stu-id="ab3e1-566">Keywords</span></span>

#### <a name="keywordsspaineunationalidcard"></a><span data-ttu-id="ab3e1-567">Keywords_spain_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="ab3e1-567">Keywords_spain_eu_national_id_card</span></span>

<span data-ttu-id="ab3e1-568">dni</span><span class="sxs-lookup"><span data-stu-id="ab3e1-568">dni</span></span>
  
<span data-ttu-id="ab3e1-569">national identification number</span><span class="sxs-lookup"><span data-stu-id="ab3e1-569">national identification number</span></span>
  
<span data-ttu-id="ab3e1-570">국가 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-570">national identity number</span></span>
  
<span data-ttu-id="ab3e1-571">보험 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-571">insurance number</span></span>
  
<span data-ttu-id="ab3e1-572">개인 식별 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-572">personal identification number</span></span>
  
<span data-ttu-id="ab3e1-573">국가 id</span><span class="sxs-lookup"><span data-stu-id="ab3e1-573">national identity</span></span>
  
<span data-ttu-id="ab3e1-574">개인 id 없음</span><span class="sxs-lookup"><span data-stu-id="ab3e1-574">personal identity no</span></span>
  
<span data-ttu-id="ab3e1-575">고유 id 번호</span><span class="sxs-lookup"><span data-stu-id="ab3e1-575">unique identity number</span></span>
  
<span data-ttu-id="ab3e1-576">nationalidno #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-576">nationalidno#</span></span>
  
<span data-ttu-id="ab3e1-577">uniqueid</span><span class="sxs-lookup"><span data-stu-id="ab3e1-577">uniqueid#</span></span>
  
<span data-ttu-id="ab3e1-578">dni</span><span class="sxs-lookup"><span data-stu-id="ab3e1-578">dni#</span></span>
  
<span data-ttu-id="ab3e1-579">nationalid #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-579">nationalid#</span></span>
  
<span data-ttu-id="ab3e1-580">nie #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-580">nie#</span></span>
  
<span data-ttu-id="ab3e1-581">nie</span><span class="sxs-lookup"><span data-stu-id="ab3e1-581">nie</span></span>
  
<span data-ttu-id="ab3e1-582">nienúmero #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-582">nienúmero#</span></span>
  
<span data-ttu-id="ab3e1-583">nie número</span><span class="sxs-lookup"><span data-stu-id="ab3e1-583">nie número</span></span>
  
<span data-ttu-id="ab3e1-584">documento nacional de identidad</span><span class="sxs-lookup"><span data-stu-id="ab3e1-584">documento nacional de identidad</span></span>
  
<span data-ttu-id="ab3e1-585">identidad único</span><span class="sxs-lookup"><span data-stu-id="ab3e1-585">identidad único</span></span>
  
<span data-ttu-id="ab3e1-586">número nacional identidad</span><span class="sxs-lookup"><span data-stu-id="ab3e1-586">número nacional identidad</span></span>
  
<span data-ttu-id="ab3e1-587">dni número</span><span class="sxs-lookup"><span data-stu-id="ab3e1-587">dni número</span></span>
  
<span data-ttu-id="ab3e1-588">dninúmero #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-588">dninúmero#</span></span>
  
<span data-ttu-id="ab3e1-589">identidadúnico #</span><span class="sxs-lookup"><span data-stu-id="ab3e1-589">identidadúnico#</span></span>
  
## <a name="sweden"></a><span data-ttu-id="ab3e1-590">스웨덴</span><span class="sxs-lookup"><span data-stu-id="ab3e1-590">Sweden</span></span>

<span data-ttu-id="ab3e1-591">자세한 내용은 [중요 한 정보 유형이 찾는](what-the-sensitive-information-types-look-for.md)"스웨덴 국가 ID" 섹션을 참조 하십시오.</span><span class="sxs-lookup"><span data-stu-id="ab3e1-591">For details, see the section "Sweden National ID" in [What the sensitive information types look for](what-the-sensitive-information-types-look-for.md).</span></span>
  
## <a name="see-also"></a><span data-ttu-id="ab3e1-592">참고 항목</span><span class="sxs-lookup"><span data-stu-id="ab3e1-592">See also</span></span>

[<span data-ttu-id="ab3e1-593">중요한 정보 형식이 찾는 항목</span><span class="sxs-lookup"><span data-stu-id="ab3e1-593">What the sensitive information types look for</span></span>](what-the-sensitive-information-types-look-for.md)
