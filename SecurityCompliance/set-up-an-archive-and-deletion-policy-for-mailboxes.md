...
5. 다음 스크린샷에서 강조 표시 된 9 개의 보존 태그를 추가 합니다 (추가 [정보](set-up-an-archive-and-deletion-policy-for-mailboxes.md#moreinfo) 섹션에서는 이러한 태그에 대해 자세히 설명 됨). 보존 태그를 추가 하려면 선택 하 고 **추가**를 클릭 합니다. 
...
그거에요! 알파인 집 조 직에 대 한 보관 및 삭제 정책을 설정 했습니다.
...
- 보존 기간은 어떻게 계산 됩니까? 사서함 항목의 보존 기간은 배달 날짜 또는 전송 되지 않았지만 사용자가 만든 임시 메시지 등의 항목에 대 한 만든 날짜부터 계산 됩니다. 관리 되는 폴더 도우미가 사서함의 항목을 처리할 때 삭제 및 복구 허용 또는 영구 삭제 보존 작업을 사용 하 여 보존 태그가 있는 모든 항목의 시작 날짜와 만료 날짜를 스탬프 처리 합니다. 보관 태그가 있는 항목은 이동 날짜로 스탬프 처리 됩니다. 
...
- 다음 표에는이 항목의 단계를 수행 하 여 만든 사용자 지정 보존 정책에 추가 되는 각 보존 태그에 대 한 자세한 정보가 나와 있습니다.
    ...
    |1개월 후 삭제  <br/> |30 일이 지난 항목을 영구적으로 삭제 합니다. 사용자는 삭제 한 14 일 동안 이러한 항목을 복구할 수 있습니다.<sup>\*</sup> <br/> |기본 제공  <br/> |비공개 이 태그는 사용자가 적용할 수 있습니다.  <br/> |
    |1년 후 삭제  <br/> |365 일 이전 항목을 영구적으로 삭제 합니다. 사용자는 삭제 한 14 일 동안 이러한 항목을 복구할 수 있습니다.<sup>\*</sup> <br/> |기본 제공  <br/> |비공개 이 태그는 사용자가 적용할 수 있습니다.  <br/> |
