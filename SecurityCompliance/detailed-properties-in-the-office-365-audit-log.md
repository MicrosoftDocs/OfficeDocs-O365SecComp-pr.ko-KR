...
|internallogontype|내부용으로 예약 되어 있습니다.|Exchange (사서함 활동)|
...
|SecurityComplianceCenterEventType|작업이 보안 &amp; 및 준수 센터 이벤트 임을 나타냅니다. 이 속성 &amp; 에 대 한 모든 보안 준수 센터 작업의 값은 **0** 입니다.|Office 365 보안 및 준수 센터|
...
|Subject|액세스 한 메시지의 제목 줄입니다.|Exchange (사서함 활동)|
