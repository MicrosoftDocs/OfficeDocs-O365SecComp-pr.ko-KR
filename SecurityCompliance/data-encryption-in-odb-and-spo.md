...
전체적으로 Office 365 보안에 대 한 [보안에서 Office 365 백서를](https://go.microsoft.com/fwlink/p/?LinkId=270895)참조 하십시오.
...
BitLocker는 서비스에서 비즈니스 및 SharePoint Online에 대 한 OneDrive에 대 한 배포 됩니다. 파일당 암호화는도 Office 365 다중 테 넌 트 및 다중 테 넌 트 기술을 바탕으로 구축 된 새로운 전용된 환경에서 비즈니스 및 SharePoint Online에 대 한 OneDrive 중입니다.
...
FIPS 140-2 준수 하는 방법에 대 한 자세한 내용은 [FIPS 140-2 규정 준수](https://go.microsoft.com/fwlink/?LinkId=517625)를 참조 하십시오.
  
나머지 부분에서 파일 수준 암호화 blob 저장소 거의 무제한 저장소 확장을 제공 하 고 맞 았습니다 보호 기능을 활성화 하려면 활용할 수 있습니다. SharePoint Onlinewill 비즈니스용 OneDrive의 모든 고객 콘텐츠 저장소 blob로 마이그레이션해야 합니다. 해당 데이터를 보호 하는 방법을 다음과 같습니다.
