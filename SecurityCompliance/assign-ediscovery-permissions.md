...
- **eDiscovery 관리자** -eDiscovery 관리자 보안에서 콘텐츠 검색 도구를 사용할 수 &amp; 는 조직에서 콘텐츠 위치를 검색 하 고 미리 보기 등의 다양 한 검색 관련 작업을 수행 하 고 검색 내보내기에 준수 센터 결과입니다. 구성원 수도 및 eDiscovery 사례 관리, 추가 하 고 사례에 구성원을 제거, 사례 보류 만들기 만들고 경우 및 Office 365 고급 ediscovery에서 사례 데이터 액세스와 관련 된 콘텐츠 검색을 실행 합니다.  EDiscovery 관리자만 액세스할 수 있는 만들 사례 및 관리 합니다. 액세스 하거나 다른 eDiscovery 관리자가 만든 경우를 관리할 수는 없습니다. 
...
보안에서 **사용 권한** 페이지에서 &amp; 준수 센터를 할당할 수도 있습니다 사용자 권한을 eDiscovery 관련 규정 준수 관리자, 조직 관리 및 검토자 역할 그룹에 추가 하 여 합니다. 에 대 한 설명은 eDiscovery 관련 RBAC 역할을 이러한 각 역할 그룹에 할당 된 [RBAC 역할 eDiscovery와 관련 된](#rbac-roles-related-to-ediscovery) 섹션을 참조 합니다. 

## <a name="rbac-roles-related-to-ediscovery"></a>EDiscovery와 관련 된 RBAC 역할

다음 표에서 보안 & 준수 센터의에서 eDiscovery 관련 RBAC 역할을 나열 하 고 기본적으로 각 역할에 할당 된 기본 제공 역할 그룹을 나타냅니다. 
...
|검색 및 삭제 <br/> | <br/> | <br/> |![확인 표시](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> | 
||||
  
다음 섹션에서는 eDiscovery 관련 RBAC 역할을 위의 표에 나열 된 각에 대해 설명 합니다.

### <a name="case-management"></a>사례 관리

이 역할에는 사용자를 만들기, 편집, 삭제 및 보안 & 준수 센터의에서 eDiscovery 사례에 대 한 액세스를 제어할 수 있습니다. 자세한 내용은 참조 [Office 365 보안에서 eDiscovery 사례 관리 &amp; 준수 센터](manage-ediscovery-cases.md)합니다. 앞에서 설명한 것 처럼 사용자 할당 되어야 합니다 사례 관리 역할에 eDiscovery 관리자 **추가 eDiscoveryCaseAdmin** cmdlet을 사용할 수 있습니다. 

### <a name="compliance-search"></a>규격 검색

이 역할에 사용자가 보안 & OneDrive 비즈니스 사이트에 대 한 비즈니스 대화, Office 365 그룹 및 팀이 Microsoft Skype 사서함 및 공용 폴더, SharePoint Online 사이트를 검색 하려면 준수 센터의에서 콘텐츠 검색 도구를 실행할 수 있습니다. 이 역할을 예상 검색 결과 가져오고 내보내기 보고서를 만들 사용자 수는 있지만 추가 역할 미리 보기, 내보내기, 또는 검색 결과 삭제 하는 등의 콘텐츠 검색 작업을 시작 하는데 사용 됩니다.

사용자 준수 검색 역할을 할당 이지만 미리 보기 역할 없는 미리 보기 동작이 미리 보기 역할에 할당 하는 사용자가 시작 된 하는 검색의 결과 미리볼 수 있습니다. 미리 보기 역할 없는 사용자 초기 미리 보기 작업 만들어진 후에 최대 2 주에 대 한 결과 미리볼 수 있습니다.

마찬가지로 준수 검색 역할을 할당 하는 사용자 수 있지만 역할 내보내기 역할에 할당 하는 사용자가 내보내기 작업에 시작 하는 검색의 결과 다운로드할 수 있는 내보내기 필요는 없습니다. 내보내기 역할 없는 사용자의 초기 내보내기 작업을 만든 후 최대 2 주에 대 한 검색 결과 다운로드할 수 있습니다. 그 다음 내보내기 역할을 가진 사람이 내보내기를 다시 시작 하지 않는 한 결과 다운로드 하는 것이 수 없습니다.

자세한 내용은 [Office 365에서 콘텐츠 검색](content-search.md)을 참조 하십시오. 

### <a name="export"></a>내보내기

역할은 로컬 컴퓨터에 콘텐츠 검색의 결과 내보낼 수 있도록 합니다. 고급 eDiscovery에 대 한 분석을 위해 검색 결과 준비 하 수 있습니다. 

검색 결과 내보내기 (영문) 하는 방법에 대 한 자세한 내용은 [Office 365 보안 & 준수 센터의에서 검색 결과 내보내기](export-search-results.md)를 참조 하십시오.

### <a name="hold"></a>보류

이 역할에 사용자 사서함에서 공용 폴더, 사이트, Skype 비즈니스 대화에 대 한 콘텐츠를 배치할 수 있도록 하 고 Office 365 그룹에서 유지 합니다. 보류에 콘텐츠가 있는 경우 콘텐츠 소유자는 여전히을 수정 하거나 원래 콘텐츠를 삭제할 수 있지만 콘텐츠 보존이 제거 하거나 보존 기간이 만료 될 때까지 유지 됩니다. 

보류에 대 한 자세한 내용은 다음을 참조 합니다.

- [Office 365 보안 & 준수 센터의에서 eDiscovery 사례](ediscovery-cases.md) 
- [보존 정책 개요](retention-policies.md)

### <a name="preview"></a>미리 보기

이 역할에 사용자가 콘텐츠 검색에서 반환 된 항목의 목록을 볼 수 있습니다. 이러한 수를 열고 해당 콘텐츠를 보려면 목록에서 각 항목을 봅니다.

### <a name="review"></a>검토 

이 역할에 사용자가 Office 365 고급 ediscovery에서 사례 데이터에 액세스할 수 있습니다. 이 역할의 주요 목적은 고급 ediscovery 사용자 액세스를 제공 하는 것입니다. 이 역할에 할당 된 사용자에 게 참조 수 있으며 보안 &의 멤버인 준수 센터의 사례 eDiscovery 페이지에서 목록을 엽니다. 사용자가 보안 & 준수 센터의에서 사례에 액세스 한 후에 액세스 하 고 고급 ediscovery에서 사례 데이터를 분석 하려면 **고급 ediscovery 스위치** 클릭할 수 있습니다. 이 역할의 대/소문자와 관련 된 콘텐츠 검색 결과를 미리보려면 또는 다른 콘텐츠 검색 또는 사례 관리 작업을 수행 하는 사용자를 허용 하지 않습니다.

### <a name="rms-decrypt"></a>RMS 암호 해독

이 역할을 사용 사용자가 암호 해독 RMS 암호화 전자 메일 메시지 고급 eDiscovery의 결과 또는 분석을 위해 준비 검색 결과 검색 내보내기 (영문). 검색 결과 내보내는 동안 암호를 해독 하는 방법에 대 한 자세한 내용은 [Office 365 보안 & 준수 센터의에서 검색 결과 내보내기](export-search-results.md)를 참조 하십시오.

### <a name="search-and-purge"></a>검색 및 삭제

이 역할에는 콘텐츠 검색 조건과 일치 하는 데이터의 대량 제거를 수행 하는 사용자 수 있도록 합니다. 자세한 내용은 [Office 365 조직에서 전자 메일 메시지를 삭제 하 고 검색에 대 한](search-for-and-delete-messages-in-your-organization.md)를 참조 하십시오. 
