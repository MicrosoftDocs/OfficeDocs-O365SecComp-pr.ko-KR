...
- 피싱 방지 정책에 따라 첫번째 ATP 설정 하려면 약 5-15 분 투자 계획 합니다.
...
설정 하거나 편집 ATP 피싱 방지 정책에 여러 옵션 중에서 선택할 수 있습니다는 다음 표에 설명 된 대로 합니다.
...
조직에서 ATP 피싱 방지 정책을 설정한 후에 [고급 위협 보호에 대 한 보고서를 확인](view-reports-for-atp.md)하 여 서비스가 작동 하는 방법을 볼 수 있습니다.
...
4. **피싱 방지** 페이지 **피싱 방지** 페이지에 표시 된 목록에서 정책 이름을 선택 합니다. 표시 되는 페이지에서 **정책을 삭제**를 선택 합니다. 모든 Office 365 데이터 센터에 분산 하 여 변경 내용 최대 30 분까지를 허용 합니다.
