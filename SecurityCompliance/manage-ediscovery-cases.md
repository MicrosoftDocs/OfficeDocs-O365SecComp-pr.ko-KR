...
4. 사례에 대 한 검색 목록에서 검색 결과를 내보내려는 검색을 클릭 하 고 내보내기 검색 결과 아이콘 ****![](media/47205c65-babd-4b3a-bd7b-98dfd92883ba.png)을 클릭 한 다음 **결과 내보내기**를 클릭 합니다.
    ...
    **검색 결과 내보내기** 페이지가 표시됩니다. 사례와 관련된 콘텐츠 검색의 결과를 내보내는 워크플로는 **콘텐츠 검색** 페이지에서 검색 결과를 내보내는 것과 같습니다. 단계별 지침은 [Security & 준수 센터에서 검색 결과 내보내기를](export-search-results.md)참조 하십시오.
...
6. * * *n* 검색에 대 한 검색 결과 내보내기 * * 페이지가 표시 되 고 여기에서 *n* 은 결과를 내보낼 검색 수입니다. 내보내기 작업의 이름을 지정 해야 합니다. 
    ...
    사례와 연결 된 여러 콘텐츠 검색 결과를 내보내는 워크플로는 단일 검색에 대 한 검색 결과를 내보내는 것과 같습니다. 단계별 지침은 [Security & 준수 센터에서 검색 결과 내보내기를](export-search-results.md)참조 하십시오.
