...
---
# <a name="eu-phone-number"></a>EU 전화번호

Office 365 보안에서 데이터 손실 방지 (DLP) &amp; 준수 센터 DLP 정책에서 사용 하 여 사용할 수 있는 많은 중요 한 정보 유형을 포함 합니다. 이 항목에서는 EU 전화번호 중요 한 정보 유형에 설명 합니다. 
...
- 정규식 `Regex_austria_eu_telephone_number_1` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_austria_eu_telephone_number` 를 찾을 수 있습니다. 
    
DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 75% 신뢰합니다.
  
- 정규식 `Regex_austria_eu_telephone_number_2` 패턴과 일치 하는 콘텐츠를 찾습니다. 
...
- 정규식 `Regex_belgium_eu_telephone_number_1` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_belgium_eu_telephone_number` 를 찾을 수 있습니다. 
    
DLP 정책은 다음과 같은 경우 이러한 유형의 중요한 정보가 300자 이내의 접근성으로 검색되었음을 75% 신뢰합니다.
  
- 정규식 `Regex_belgium_eu_telephone_number_2` 패턴과 일치 하는 콘텐츠를 찾습니다. 
...
- 정규식 `Regex_bulgaria_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_bulgaria_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_croatia_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_croatia_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_cyprus_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_cyprus_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_czech_republic_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_czech_republic_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_denmark_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_denmark_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_estonia_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_estonia_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_finland_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_finland_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_france_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_france_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_germany_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_germany_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_greece_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_greece_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_hungary_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_hungary_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_ireland_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_ireland_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_italy_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_italy_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_latvia_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_latvia_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_lithuania_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_lithuania_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_luxemburg_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_luxemburg_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_malta_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_malta_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_netherlands_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_netherlands_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_poland_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_poland_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_portugal_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_portugal_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_romania_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_romania_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_slovakia_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_slovakia_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_slovenia_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_slovenia_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_spain_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_spain_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_sweden_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_sweden_eu_telephone_number` 를 찾을 수 있습니다. 
...
- 정규식 `Regex_uk_eu_telephone_number` 패턴과 일치 하는 콘텐츠를 찾습니다. 
    
- 키워드에서 `Keywords_uk_eu_telephone_number` 를 찾을 수 있습니다. 
