...
Office 365 보안에서 데이터 손실 방지 (DLP) &amp; 준수 센터는 미국 건강 보험 Act (될 수 있는 중요 한 정보를 보호할 수 있도록 도와 같은 일반적인 규정 준수 요구 사항을 해결 하는 즉시 사용 정책 서식 파일에 포함 되어있습니다. HIPAA) 미국 금융-서비스 현대화 법-Bliley Act (GLBA) 또는 미국 Patriot Act 합니다. 이 항목 서식 파일을 찾을 어떤 종류의 중요 한 정보 및 기본 조건 및 동작 이란 모든 정책을 나열 합니다. 이 항목의 각 정책 서식 파일 구성 방법; 기울 포함 되지 않습니다. 대신, 항목 충분 한 정보를 서식 파일을 자신의 시나리오에 대 한 가장 시작점을 결정할 수 있습니다를 제공 합니다. 기억 특정 요구 사항을 충족 하기 위해 이러한 정책 서식 파일을 사용자 지정할 수 있습니다.
...
|**규칙 이름**|**조건 <br/> (중요 한 정보 유형 포함)**|**작업**|
|:-----|:-----|:-----|
|EU 민감한 콘텐츠를 찾을 낮은 볼륨  <br/> | 콘텐츠에 중요한 정보가 포함됨:  <br/>  유럽 직불 카드 번호 - 최소 개수 1, 최대 개수 9  <br/>  EU 운전 면허 번호-Min count 1, 최대 개수 9  <br/>  EU 국가 Id 번호-Min count 1, 최대 개수 9  <br/>  EU 여권 번호-Min count 1, 최대 개수 9  <br/>  EU 사회보장 번호 (SSN) 또는 해당 하는 ID-Min count 1, 최대 개수 9  <br/>  EU 세금 식별 번호 (주석)-Min count 1, 최대 개수 9  <br/>  콘텐츠 공유 대상:  <br/>  조직 외부의 사용자  <br/> |인시던트 관리자에 게 보고서 보내기  <br/> |
|많은 양의 EU 민감한 콘텐츠를 찾을 수합니다  <br/> | 콘텐츠에 중요한 정보가 포함됨:  <br/>  유럽 직불 카드 번호 - 최소 개수 1, 최대 개수 9  <br/>  EU 운전 면허 번호-Min count 1, 최대 개수 9  <br/>  EU 국가 Id 번호-Min count 1, 최대 개수 9  <br/>  EU 여권 번호-Min count 1, 최대 개수 9  <br/>  EU 사회보장 번호 (SSN) 또는 해당 하는 ID-Min count 1, 최대 개수 9  <br/>  EU 세금 식별 번호 (주석)-Min count 1, 최대 개수 9  <br/>  콘텐츠 공유 대상:  <br/>  조직 외부의 사용자  <br/> | 외부 사용자에 대 한 내용에 대 한 액세스 제한  <br/>  전자 메일 및 정책 팁을 사용 하는 사용자에 게 알림  <br/>  재정의 허용  <br/>  업무 정당성 필요  <br/>  인시던트 관리자에 게 보고서 보내기  <br/> |
...
|**규칙 이름**|**조건 <br/> (중요 한 정보 유형 포함)**|**작업**|
|:-----|:-----|:-----|
|미국 HIPAA 일치 하는 콘텐츠  <br/> | 다음과 같은 중요 한 정보 중 하나를 포함 합니다.  <br/>  모든 미국 사회보장 번호 (SSN)-Min count 1, 최대 개수  <br/>  모든 약물 집행 기구 (DEA) 번호-Min count 1, 최대 개수  <br/> **및** <br/>  콘텐츠를 포함 하 여 이러한 조건 중 하나:  <br/>  국제 분류의 병 비교 (ICD-9-CM)-모든 Min count 1, 최대 개수  <br/>  국제 분류의 병 비교 (ICD-10-CM)-모든 Min count 1, 최대 개수  <br/>  콘텐츠 공유 대상:  <br/>  조직 외부의 사용자  <br/> |알림 보내기  <br/> |
